...
![](https://foruda.gitee.com/images/1664635745971665615/04bcf218_5369110.png "屏幕截图")
3. 如果显示 “这些是此游戏开发这发布的官方案件设置”，那么说明使用的不是你的配置
![输入图片说明](https://foruda.gitee.com/images/1664635836286821684/f68cd0ce_5369110.png "屏幕截图")
4. 点击 编辑，弹出面板后，点击 替换为默认配置
![](https://foruda.gitee.com/images/1664635916156147907/c6b4bd21_5369110.png "屏幕截图")
5. 填写你的信息，点击保存
![](https://foruda.gitee.com/images/1664635964201435195/51351056_5369110.png "屏幕截图")
6. 最后显示为你的配置，此时发布可以了
...
交互分手势交互和射线（手柄发送射线）交互两种情况，一般情况下，我们都用射线来交互，如和UI交互，大部分模型（如，仿真检查设备操作），手势操作的包含如：拉动滑块，转动轮盘等情况
...
![输入图片说明](../../assets/Unity/20230316/1.png)
