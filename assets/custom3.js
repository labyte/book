var initAll = function () {
    ...
    script.setAttribute("data-repo", "labyte/book");
    script.setAttribute("data-repo-id", "R_kgDOMBDvdw");
    script.setAttribute("data-category", "Announcements");
    script.setAttribute("data-category-id", "DIC_kwDOMBDvd84Cjq0p");
